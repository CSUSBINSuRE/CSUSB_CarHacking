...
while not done:
	...
	mainmenu = input('Press 1 to Open Cansniffer\nPress 2 to start capture with WIRESHARK\nPress 3 to open Both\nPress 4 to Change default bitrate\nPress 5 to Close BE SURE to save any captured data with Wireshark before closing\n')
